...
public class ContractController {
    ...
    public Map<String, String> downloadImgUrl(HttpServletRequest request, String fouceDownload, String tId, String certTypeCode) { 
        ...
        boolean resultBool = FTPUtils.downloadFile("192.168.2.142", 21, "webftp", "webftp","contract/",filePath , uploadDir);
...
//					String fileName = UUID.randomUUID().toString().replace("-", "") + resFileName.substring(resFileName.lastIndexOf("."));
			        ...
			        boolean flag = FTPUtils.uploadFile("192.168.2.142", 21, "webftp", "webftp","","contract/",resFileName, in);
					result.put("status", "OK");
...
//				bean.setDebAmoLimit(Long.parseLong(cell[6]));
	        ...
	        if (result.size() != 0) {
		        ...
		        boolean flag = FTPUtils.uploadFile("192.168.2.142", 21, "webftp", "webftp","","contract/",fileName , in);
			}else{
