	  ...
	  $(function() {
		...
		function DetailParaDic(result) {
			...
			$("#button_ins3").linkbutton('disable');
			 ...
			 var flag = 5;
			 window.location.href= "<%=basePath%>" +'agency/showProdCase?memberId='+ memberId +'&flag='+flag;;
		  }
		function closeAdd(){
			$('#w').window('close');
		}
	 function showUser(){
		 $("#button_ins4").linkbutton('disable');
		 $("#button_ins5").linkbutton('disable');
		 $("#button_ins6").linkbutton('disable');
		 var memberId = $("#merchApplyId").val();
		 var pid = $("#prdtVer").val();
			$.ajax({
			   type: "POST",
