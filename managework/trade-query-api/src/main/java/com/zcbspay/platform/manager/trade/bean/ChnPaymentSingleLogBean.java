...
public class ChnPaymentSingleLogBean implements Serializable {

	private static final long serialVersionUID = -180176400536742645L;
	private String tid;// 标识
	private String msgid;// 报文标识号
	private String receivetype;// 接收标识
